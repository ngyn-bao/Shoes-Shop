...
<body class="bg-light">
  ...
  <div class="main-content">
    ...
    <div class="row g-4">
      <div class="col-md-3">
        <div class="card text-center p-3" onclick="location.href='admin_user.php'">
      ...
      <div class="col-md-3">
        <div class="card text-center p-3" onclick="location.href='products.php'">
      ...
      <div class="col-md-3">
        <div class="card text-center p-3" onclick="location.href='orders.php'">
      ...
      <div class="col-md-3">
        <div class="card text-center p-3" onclick="location.href='contacts.php'">
    ...
    <div class="row g-4 mt-5">
      <div class="col-md-3">
        <div class="card text-center p-3" onclick="location.href='ArticleIndex.php'">
