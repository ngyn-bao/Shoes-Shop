          ...
          <div class="card-body">
            <form action="../api/Articles/updateArticle.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control form-control-lg" id=" title" value="<?= htmlspecialchars($article['title']) ?>" required>
              </div>
              <div class="mb-3">
                <label class="form-label">Hình ảnh</label>
                <input type="url" name="image" class="form-control" id=" image" value="<?= htmlspecialchars($article['image_url']) ?>">
              </div>
              <div class="mb-4">
                <label class="form-label fw-bold">Nội dung</label>
                <textarea name="content" class="form-control" id=" content" rows="15" required><?= htmlspecialchars($article['content']) ?></textarea>
              </div>
              <div class="text-end">
