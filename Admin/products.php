...
<head>
    ...
    <style>
        ...
        .table img { object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
        .price-original { text-decoration: line-through; color: #95a5a6; font-size: 0.9em; }
        .price-sale { color: #e74c3c; font-weight: bold; font-size: 1.1em; }
        .btn-action { font-size: 0.85rem; padding: 0.35rem 0.75rem; }
